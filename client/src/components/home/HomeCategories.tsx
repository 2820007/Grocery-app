  ...
  return (
    <section className="py-16">
        <div className="max-w-7xl mx-auto">
            ...
            <div className="flex items-center mt-8 overflow-x-scroll n-scrollbar">
                {
                categoriesData.map((cat)=>(
                    <Link to={`/products?category=${cat.slug}`} key={cat.slug} onClick={()=>window.scrollTo(0,0)} className="group flex flex-col items-center gap-3 p-4">
