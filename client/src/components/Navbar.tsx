              ...
              <>
                ...
                <div className="absolute right-0 mt-2.5 w-56 bg-white rounded-xl shadow-lg border border-app-border py-2 z-50 animate-fade-in ">
                  ...
                  <div onClick={() => setUserMenuOpen(false)}>
                    ...
                    {user && (
                      <Link className="dropdown-link" to="/address">
                        <MapPinIcon size={16} />
                        Address
                      </Link>
                    )}

                    <Link className="dropdown-link md:hidden" to="/products">
                      <ArrowUpRightIcon size={16} /> Products
                    </Link>

                    <Link className="dropdown-link md:hidden" to="/deals">
