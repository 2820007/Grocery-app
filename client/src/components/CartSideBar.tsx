...
const CartSideBar = () => {
  ...
  return ( 
     <>
     <div  onClick={()=>setIsCartOpen(false)} className="fixed inset-0 bg-black/40  z-40 transition-opacity"/>
     {/* sidebar */}
    ...
    {/* Items */}
       <div className="flex-1 overflow-y-auto p-5 space-y-4">
        {items.length===0 ? (
          ...
          items.map((item)=>(
            <div className="flex gap-3 bg-app-cream rounded-xl p-3
        ...
        items.length >0 && (
          <div className="p-5 border-t border-app-border space-y-3 ">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">{deliveryFee ===0 ? <span className="text-app-success">
                Free
            ...
            {
              deliveryFee >0 && <p className="text-sm text-app-text-light text-center">Free delivery on order over {currency}20!</p>
            }
