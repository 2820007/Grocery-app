...
import { ClockIcon, LeafIcon, MailIcon, MapPinIcon, PhoneIcon, ShieldCheckIcon, TruckIcon } from "lucide-react";
...
export const appPromoBannerData = {
    ...
    description: "Download the FreshMart app for exclusive deals, real-time tracking, and the freshest selection delivered right to your door.",
};
