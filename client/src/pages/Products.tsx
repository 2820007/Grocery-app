         ...
         <div className="flex gap-8 xl:gap-10">
          ...
          <aside className="hidden lg:block w-64 shrink-0">
            <div className="bg-white rounded-2xl p-4 sticky top-24">
              ...
              minPrice={minPrice} maxPrice={maxPrice} updateFilter={updateFilter} clearFilter={clearFilter} 
...

            {
              loading ? (
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-sm text-app-text-light mb-4">Tyr adjusting your filters or search terms</p>
